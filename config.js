...
const DEFAULT_OFFERS = [
  { id: 1, title: "خصم 10% على كل الطلبات", type: "percent", value: 10, minOrder: 500, active: true },
  { id: 2, title: "خصم 200 دج عند 1000 دج", type: "fixed", value: 200, minOrder: 1000, active: false },
];
...
function loadOffers() {
  const saved = localStorage.getItem("dj_offers");
  return saved ? JSON.parse(saved) : DEFAULT_OFFERS;
}

function saveOffers(o) { 
  localStorage.setItem("dj_offers", JSON.stringify(o)); 
}
