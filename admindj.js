...
function saveOffer() {
  ...
  if (editId) {
    ...
    offers[idx] = { ...offers[idx], title, type, value, minOrder };
  } else {
    offers.push({ id: Date.now(), title, type, value, minOrder, active: true });
  }
...
function toggleOffer(id) {
  const o = offers.find(o => o.id == id);
  if (o) { o.active = !o.active; saveOffers(offers); renderOffers(); }
}
